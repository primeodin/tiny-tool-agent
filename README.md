...
Weekday cadence, in order: chat CLI → RAG → tokenizer → **tool agent (this)** → prompt lab → embedding playground → **vision caption loop (shipped)** → memory → shop-skill explainer.
